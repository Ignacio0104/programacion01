...
{
	eDisplay* pDisplay=malloc(sizeof(eDisplay));
...
int disp_initList(eDisplay *displaysList[],int lenght) //Array de punteros * y []
{
	int retorno;
...
int disp_buscarDisponible(eDisplay *displaysList[], int lenght) //Modificado para array de punteros
{
	int retorno;
	retorno=-1;
